          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              ...
              {publications.map((pub, i) => (
                <div
                  key={i}
                  className="glow-border glass-card p-6 relative overflow-hidden group"
                >
                  ...
                  <div className="space-y-1.5 ml-13">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <a
                        href="https://ieeexplore.ieee.org/document/11013965/authors#authors"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-mono text-xs text-neon-blue border border-neon-blue/30 bg-neon-blue/5 px-2 py-0.5"
                      >
                        DOI
                      </a>
                    </div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  >
                    ...
                    <span className="font-mono text-xs text-slate-400 group-hover:text-slate-300">
                      {skill}
                    </span>
                  </div>
                ))}
