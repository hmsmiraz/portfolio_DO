        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project: Project, i: number) => (
            <a
              ...
              className="relative glow-border glass-card p-6 flex flex-col gap-4 transition-all duration-300 cursor-pointer group no-underline"
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.tools.map((tool: string, j: number) => (
                  <span
                    key={j}
                    className="font-mono text-xs px-2 py-0.5 bg-white/5 border border-white/10 text-slate-400 hover:text-slate-300 hover:border-white/20 transition-all"
                  >
                    {tool}
                  </span>
                ))}
              ...
              <div className="flex items-center gap-2 pt-3 border-t border-white/5 mt-auto">
                ...
                <span className="ml-auto text-slate-600 group-hover:text-neon text-sm transition-colors">
                  ↗
                </span>
              </div>
